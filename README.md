...
> ⚠️ **Project status: maintenance mode.** This project is no longer under active feature development. Sayurin's [pyhems](https://github.com/sayurin/pyhems) is a modern, actively developed alternative.
> PRs from the community will still be welcomed. 
>
